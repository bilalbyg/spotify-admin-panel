...
export default function Login() {
  ...
  const fullTitle = "ACCESS TERMINAL"
  ...
  return (
    ...
    >
      ...
      <style>{`
                ...
                input::placeholder { color: #2a2a2a !important; font-family: 'Share Tech Mono', 'Courier New', monospace; letter-spacing: 1px; }
                input:-webkit-autofill { -webkit-box-shadow: 0 0 0 1000px #000 inset !important; -webkit-text-fill-color: #00ff00 !important; caret-color: #00ff00; }
            `}</style>
    </div>
  )
}
